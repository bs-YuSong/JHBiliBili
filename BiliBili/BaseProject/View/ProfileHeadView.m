...
- (void)drawRect:(CGRect)rect {
    ...
    size.width /= scale;
    size.height /= scale;
    [self.img drawInRect:CGRectMake(self.frame.size.width - size.width, self.frame.size.height - size.height, size.width, size.height) blendMode:kCGBlendModeOverlay alpha:0.5];
}
